...
/**
 * Klasa za konfiguraciju s binarnin zapisom podataka (serijalizacija) u
 * datoteku.
 */
public final class KonfiguracijaBin extends KonfiguracijaApstraktna {
	...
	public void spremiKonfiguraciju(String datotekaNaziv) throws NeispravnaKonfiguracija {
		...
		if (tip == null || tip.compareTo(KonfiguracijaBin.TIP) != 0) {
			throw new NeispravnaKonfiguracija("Datoteka: " + datotekaNaziv + " nema tip: " + KonfiguracijaBin.TIP);
	...
	public void ucitajKonfiguraciju() throws NeispravnaKonfiguracija {
		...
		if (tip == null || tip.compareTo(KonfiguracijaBin.TIP) != 0) {
			throw new NeispravnaKonfiguracija("Datoteka: " + this.nazivDatoteke + " nema tip: " + KonfiguracijaBin.TIP);
