...
import edu.unizg.foi.nwtis.tivanovic21.vjezba_08_dz_3.jpa.entiteti.Korisnici;
import edu.unizg.foi.nwtis.tivanovic21.vjezba_08_dz_3.jpa.entiteti.Korisnici_;
...
public class KorisniciFacade extends EntityManagerProducer implements Serializable {
	...
	public Korisnik pretvori(Korisnici k) {
		...
		var kObjekt = new Korisnik(k.getKorisnik(), k.getLozinka(), k.getPrezime(), k.getIme(), k.getEmail());
