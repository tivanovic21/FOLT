...
public abstract sealed class KonfiguracijaApstraktna implements Konfiguracija
	...
	protected final static String verzija = "NWTiS 2025.";
	...
	/**
	 * Kreira objekt konfiguracije, ako postoji datoteka postavki zadanog naziva
	 * učitava podatke inače kreira datoteku pod zadanim nazivom.
	 *
	 * @param nazivDatoteke the naziv datoteke
	 * @return objekt konfiguracije bez postavki
	 * @throws NeispravnaKonfiguracija ako tip konfiguracije nije podržan ili je
	 *                                 došlo do pogreške kod spremanja u datoteku
	 */
	public static Konfiguracija preuzmiKreirajKonfiguraciju(String nazivDatoteke) throws NeispravnaKonfiguracija {
